...
async function renderPrediction() {
    ...
    if (predictions.length > 0) {
        predictions.forEach(prediction => {
            ...
            // Get distance left eye
            const leftEyesDist = Math.sqrt(
                (prediction.annotations.leftEyeLower1[4][0] - prediction.annotations.leftEyeUpper1[4][0]) ** 2 +
                (prediction.annotations.leftEyeLower1[4][1] - prediction.annotations.leftEyeUpper1[4][1]) ** 2 +
                (prediction.annotations.leftEyeLower1[4][2] - prediction.annotations.leftEyeUpper1[4][2]) ** 2
            );

            // left eye blink
            if (leftEyesDist / faceScale < 17.7) {
                console.log('left eye blink');
            }

            // Get distance right eye
            const rightEyesDist = Math.sqrt(
                (prediction.annotations.rightEyeLower1[4][0] - prediction.annotations.rightEyeUpper1[4][0]) ** 2 +
                (prediction.annotations.rightEyeLower1[4][1] - prediction.annotations.rightEyeUpper1[4][1]) ** 2 +
                (prediction.annotations.rightEyeLower1[4][2] - prediction.annotations.rightEyeUpper1[4][2]) ** 2
            );
            
            if (rightEyesDist / faceScale < 17.7) {
