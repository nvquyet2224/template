...
/***/ (function(module, exports, __webpack_require__) {
	...
	function ColorPicker(options) {
	    ...
	    options = this.options = util.extend({
			...
			cssPrefixSvg: 'tui-svg-colorpicker-',
	        detailTxt: 'Detail',
	...
	Palette.prototype.render = function (color) {
	    ...
	    html = tmpl.layout.replace('{{colorList}}', util.map(options.preset, function (itemColor) {
	        ...
	        itemHtml = domutil.applyTemplate(tmpl.item, {
				...
				cssPrefixSvg: options.cssPrefixSvg,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Slider.prototype.render = function (colorStr) {
		...
		html = html.replace(/{{cssPrefixSvg}}/g, options.cssPrefixSvg);
		...
		//that.sliderHandleElement = domutil.find('.' + options.cssPrefixSvg + 'slider-handle', container);
	    //that.huebarHandleElement = domutil.find('.' + options.cssPrefixSvg + 'huebar-handle', container);
	    //that.baseColorElement = domutil.find('.' + options.cssPrefixSvg + 'slider-basecolor', container);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SVGSlider = ['<svg class="{{cssPrefix}}svg {{cssPrefix}}svg-slider">', '<defs>', '<linearGradient id="{{cssPrefixSvg}}svg-fill-color" x1="0%" y1="0%" x2="100%" y2="0%">', '<stop offset="0%" stop-color="rgb(255,255,255)" />', '<stop class="{{cssPrefix}}slider-basecolor" offset="100%" stop-color="rgb(255,0,0)" />', '</linearGradient>', '<linearGradient id="{{cssPrefixSvg}}svn-fill-black" x1="0%" y1="0%" x2="0%" y2="100%">', '<stop offset="0%" style="stop-color:rgb(0,0,0);stop-opacity:0" />', '<stop offset="100%" style="stop-color:rgb(0,0,0);stop-opacity:1" />', '</linearGradient>', '</defs>', '<rect width="100%" height="100%" fill="url(#{{cssPrefixSvg}}svg-fill-color)"></rect>', '<rect width="100%" height="100%" fill="url(#{{cssPrefixSvg}}svn-fill-black)"></rect>', '<path transform="translate(0,0)" class="{{cssPrefix}}slider-handle" d="M0 7.5 L15 7.5 M7.5 15 L7.5 0 M2 7 a5.5 5.5 0 1 1 0 1 Z" stroke="black" stroke-width="0.75" fill="none" />', '</svg>'].join('\n');
	...
	var SVGHuebar = ['<svg class="{{cssPrefix}}svg {{cssPrefix}}svg-huebar">', '<defs>', '<linearGradient id="{{cssPrefixSvg}}g" x1="0%" y1="0%" x2="0%" y2="100%">', '<stop offset="0%" stop-color="rgb(255,0,0)" />', '<stop offset="16.666%" stop-color="rgb(255,255,0)" />', '<stop offset="33.333%" stop-color="rgb(0,255,0)" />', '<stop offset="50%" stop-color="rgb(0,255,255)" />', '<stop offset="66.666%" stop-color="rgb(0,0,255)" />', '<stop offset="83.333%" stop-color="rgb(255,0,255)" />', '<stop offset="100%" stop-color="rgb(255,0,0)" />', '</linearGradient>', '</defs>', '<rect width="18px" height="100%" fill="url(#{{cssPrefixSvg}}g)"></rect>', '<path transform="translate(-6,-3)" class="{{cssPrefix}}huebar-handle" d="M0 0 L4 4 L0 8 L0 0 Z" fill="black" stroke="none" />', '</svg>'].join('\n');
